...
let InterestService = class InterestService {
    constructor(interestRepository, profileRepository) {
    ...
    addInterestToProfile(userProfile, interests) {
        return __awaiter(this, void 0, void 0, function* () {
            const profile = yield this.profileRepository.findOne(userProfile);
